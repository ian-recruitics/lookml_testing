# The name of this view in Looker is "Netsuite Vendors Purchase Order"
view: netsuite_vendors_purchase_order {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: reporting.netsuite_vendors_purchase_order ;;
