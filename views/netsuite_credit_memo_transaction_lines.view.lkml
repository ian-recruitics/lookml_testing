# The name of this view in Looker is "Netsuite Credit Memo Transaction Lines"
view: netsuite_credit_memo_transaction_lines {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: reporting.netsuite_credit_memo_transaction_lines ;;
  drill_fields: [id]
