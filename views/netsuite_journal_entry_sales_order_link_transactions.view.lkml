# The name of this view in Looker is "Netsuite Journal Entry Sales Order Link Transactions"
view: netsuite_journal_entry_sales_order_link_transactions {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: reporting.netsuite_journal_entry_sales_order_link_transactions ;;
