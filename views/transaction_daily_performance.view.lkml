# The name of this view in Looker is "Transaction Daily Performance"
view: transaction_daily_performance {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: reporting.transaction_daily_performance ;;
  drill_fields: [id]
  ...
  measure: count {
    type: count
    drill_fields: [id, attributed_campaign_name, clients.client_id, clients.client_name, transactions.id]
  }
}
