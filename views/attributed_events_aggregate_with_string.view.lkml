# The name of this view in Looker is "Attributed Events Aggregate with String"
view: attributed_events_aggregate_with_string {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: reporting.attributed_events_aggregate_with_string ;;
  drill_fields: [id]
