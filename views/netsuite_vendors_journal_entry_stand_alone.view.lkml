# The name of this view in Looker is "Netsuite Vendors Journal Entry Stand Alone"
view: netsuite_vendors_journal_entry_stand_alone {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: reporting.netsuite_vendors_journal_entry_stand_alone ;;
