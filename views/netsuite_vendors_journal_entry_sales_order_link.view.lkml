# The name of this view in Looker is "Netsuite Vendors Journal Entry Sales Order Link"
view: netsuite_vendors_journal_entry_sales_order_link {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: reporting.netsuite_vendors_journal_entry_sales_order_link ;;
