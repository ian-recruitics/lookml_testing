# The name of this view in Looker is "Attributed Events Aggregate Npc"
view: attributed_events_aggregate_npc {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: reporting.attributed_events_aggregate_npc ;;
  drill_fields: [id]
