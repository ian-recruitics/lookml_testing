# The name of this view in Looker is "Reach Sub Vendor Report Npc Events"
view: reach_sub_vendor_report_npc_events {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: reporting.reach_sub_vendor_report_npc_events ;;
  drill_fields: [id]
