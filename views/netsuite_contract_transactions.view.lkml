# The name of this view in Looker is "Netsuite Contract Transactions"
view: netsuite_contract_transactions {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: reporting.netsuite_contract_transactions ;;
