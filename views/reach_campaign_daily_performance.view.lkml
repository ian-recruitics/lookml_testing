# The name of this view in Looker is "Reach Campaign Daily Performance"
view: reach_campaign_daily_performance {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: reporting.reach_campaign_daily_performance ;;
  drill_fields: [id]
