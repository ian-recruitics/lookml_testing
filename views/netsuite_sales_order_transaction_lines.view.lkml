# The name of this view in Looker is "Netsuite Sales Order Transaction Lines"
view: netsuite_sales_order_transaction_lines {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: reporting.netsuite_sales_order_transaction_lines ;;
  drill_fields: [id]
